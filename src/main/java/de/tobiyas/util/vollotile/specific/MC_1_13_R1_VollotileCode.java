...
import net.minecraft.server.v1_13_R1.EntityArrow.PickupStatus;
...
public class MC_1_13_R1_VollotileCode extends VollotileCode {

	public MC_1_13_R1_VollotileCode() {
		super("v1_13_R1");
	}
	...
	public boolean entityWalkToLocation(LivingEntity entity, Location location, double speed){
		try{
			...
			PathEntity path = nmsEntity.getNavigation().b(new BlockPosition(location.getBlockX(), location.getBlockY(), location.getBlockZ()));
